...
Additionally, the table **Metadata_table.xlsx** gives an overview of the Thermo raw files and database search result files used in each experiment. They are available on PRIDE (identifier PXD040449). Moreover, the document **FAQ Madern et al.docx** serves to answer frequently asked questions in connection to our study.
