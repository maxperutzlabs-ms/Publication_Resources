...
ggplot_site <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
                ...
                scale_fill_manual(values=c("#BFBEBE", "#3A97AE")) + 
...
# ggplot_site.2 <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
#                 geom_line(data = summary_df_summarized_long, aes(x = group_boxplot, y = value_median, group = organism, colour = organism), linetype = 1, alpha=0.8, lwd=0.3) +
#                 geom_violin(aes(x=group, y=value, col=organism), position = position_jitterdodge(dodge.width = 0.6, jitter.width = 0), size=0, alpha=0.8) +
#                 geom_boxplot(aes(x=group, y=value), outlier.shape = NA, alpha = 0, width = .15, colour = "black", position = position_dodge(width=0.6), lwd=0.2) + 
#                 scale_fill_manual(values=c("#BFBEBE", "#3A97AE")) + 
#                 scale_color_manual(values =  pointCols) +
#                 scale_y_continuous(breaks=seq(from=-1,to=1, by=0.25), limits=c(-0.7,0.7))+
#                 scale_x_discrete(expand = c(-0.9, 1.9))+
#                 ylab("Relative abundance [log2] ") + xlab("Sample group") +
#                 ggtitle("Acetyl-site level [MS2]") +
#                 theme_cowplot() +
#                 theme(legend.position="none") +
...
# ggplot_protein.2 <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
#                 geom_line(data = summary_df_summarized_long, aes(x = group_boxplot, y = value_median, group = organism, colour = organism), linetype = 1, alpha=0.8, lwd=0.3) +
#                 geom_violin(aes(x=group, y=value, col=organism), position = position_jitterdodge(dodge.width = 0.6, jitter.width = 0), size=0, alpha=0.8) +
#                 geom_boxplot(aes(x=group, y=value), outlier.shape = NA, alpha = 0, width = .15, colour = "black", position = position_dodge(width=0.6), lwd=0.2) + 
#                 scale_fill_manual(values=c("#BFBEBE", "#3A97AE")) + 
...
ggplot_siteToProtein <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
                ...
                scale_x_discrete(expand = c(-0.6, 1.6))+
                ylab("Relative abundance [log2] ") + xlab("Sample group") +
                ggtitle("Acetyl-site/protein level [MS2/MS3]") +
                theme_cowplot() +
                theme(legend.position="none") +
                theme(text=element_text(size=6)) +
                theme(axis.text.x= element_text(size=6)) +
...
# ggplot_siteToProtein.2 <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
#                 geom_line(data = summary_df_summarized_long, aes(x = group_boxplot, y = value_median, group = organism, colour = organism), linetype = 1, alpha=0.8, lwd=0.3) +
#                 geom_violin(aes(x=group, y=value, col=organism), position = position_jitterdodge(dodge.width = 0.6, jitter.width = 0), size=0, alpha=0.8) +
#                 geom_boxplot(aes(x=group, y=value), outlier.shape = NA, alpha = 0, width = .15, colour = "black", position = position_dodge(width=0.6), lwd=0.2) + 
#                 scale_fill_manual(values=c("#BFBEBE", "#3A97AE")) + 
...
ggplot_siteToProtein_IFadjusted <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
                ...
                scale_x_discrete(expand = c(-0.6, 1.6))+
                ylab("Relative abundance [log2] ") + xlab("Sample group") +
                ggtitle("Acetyl-site/protein level [MS2/MS3, IF-adjusted]") +
                theme_cowplot() +
                theme(legend.position="none") +
                theme(text=element_text(size=6)) +
                theme(axis.text.x= element_text(size=6)) +
...
# ggplot_siteToProtein_IFadjusted.2 <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
#                 geom_line(data = summary_df_summarized_long, aes(x = group_boxplot, y = value_median, group = organism, colour = organism), linetype = 1, alpha=0.8, lwd=0.3) +
#                 geom_violin(aes(x=group, y=value, col=organism), position = position_jitterdodge(dodge.width = 0.6, jitter.width = 0), size=0, alpha=0.8) +
#                 geom_boxplot(aes(x=group, y=value), outlier.shape = NA, alpha = 0, width = .15, colour = "black", position = position_dodge(width=0.6), lwd=0.2) + 
#                 scale_fill_manual(values=c("#BFBEBE", "#3A97AE")) + 
#                 scale_color_manual(values =  pointCols) +
#                 scale_y_continuous(breaks=seq(from=-1,to=1, by=0.25), limits=c(-0.7,0.7))+
#                 scale_x_discrete(expand = c(-1.9, 1.9))+
#                 ylab("Relative abundance [log2] ") + xlab("Sample group") +
#                 ggtitle("Acetyl-site/protein level [MS2/MS3, IF-adjusted]") +
#                 theme_cowplot() +
#                 theme(legend.position="none") +
...
#                 theme(axis.text.x= element_text(size=6)) +
#                 theme(axis.text.y= element_text(size=6))
# ggplot_siteToProtein_IFadjusted.2
...
grid_all <- plot_grid(ggplot_site,
                      ...
                      ggplot_siteToProtein_IFadjusted,
                      nrow=1)
ggsave(grid_all, file ="Fig5D__AcetylsiteToProtein_YeastHuman_MS2toMS3.pdf", width = 7.8, height = 1.7)
# grid_all.2 <- plot_grid(ggplot_site.2,
#                       ggplot_protein.2,
#                       ggplot_siteToProtein.2,
#                       ggplot_siteToProtein_IFadjusted.2,
#                       nrow=1)
# ggsave(grid_all.2, file ="Fig5D__AcetylsiteToProtein_YeastHuman_MS2toMS3.2.pdf", width = 7.8, height = 1.7)
