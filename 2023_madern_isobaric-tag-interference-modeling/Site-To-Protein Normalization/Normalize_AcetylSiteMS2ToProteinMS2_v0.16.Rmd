...
output_name = "SiteMS2ToProteinMS2"
...
filepath_proteinTable = "aggregated_proteinGroups_MS2_P2P5.txt"

## Specify reporter ion column pattern in proteins table ("log2 " must not be part of the pattern!)
reporter_pattern_proteinTable = "norm__aggregated"
...
eil_columnname_proteinTable = "EIL"

## Specify column name of protein ID column in protein table
id_columnname_proteinTable = "id"

## Specify if intensities are log2 transformed in proteins table. If TRUE, they will need to be retransformed by exponentiation
bool_are_intensities_log2_transformed_in_proteinTable = FALSE
...
ggplot_site
ggsave(filename="site_MS2Prot.pdf", plot=ggplot_site, width=2.2, height=2.2)
...
ggplot_protein <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
                ...
                scale_x_discrete(expand = c(-0.6, 1.6))+
                ylab("Relative abundance [log2] ") + xlab("Sample group") +
                ggtitle("Underlying protein level [MS2]") +
                theme_cowplot() +
                theme(legend.position="none") +
                theme(text=element_text(size=6)) +
                theme(axis.text.x= element_text(size=6)) +
                theme(axis.text.y= element_text(size=6))
ggplot_protein
ggsave(filename="Protein_MS2Protein.pdf", plot=ggplot_site, width=2.2, height=2.2)
...
ggplot_siteToProtein <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
                ...
                scale_x_discrete(expand = c(-0.6, 1.6))+
                ylab("Relative abundance [log2] ") + xlab("Sample group") +
                ggtitle("Acetyl-site/protein level [MS2/MS2]") +
                theme_cowplot() +
                theme(legend.position="none") +
                theme(text=element_text(size=6)) +
                theme(axis.text.x= element_text(size=6)) +
...
ggsave(filename="siteToProtein_MS2Protein.pdf", plot=ggplot_siteToProtein, width=2.2, height=2.2)
...
ggplot_siteToProtein_IFadjusted <- ggplot(df_summarized_long, aes(x = group, y = value, fill = organism)) +
                ...
                scale_x_discrete(expand = c(-0.6, 1.6))+
                ylab("Relative abundance [log2] ") + xlab("Sample group") +
                ggtitle("Acetyl-site/protein level [MS2/MS2, IF-adjusted] ") +
                theme_cowplot() +
                theme(legend.position="none") +
                theme(text=element_text(size=6)) +
                theme(axis.text.x= element_text(size=6)) +
...
ggsave(filename="siteToProtein_IFadjusted_MS2Protein.pdf", plot=ggplot_siteToProtein_IFadjusted, width=2.2, height=2.2)
...
ggsave(grid_all, file ="Fig5F__AcetylsiteToProtein_YeastHuman_MS2toMS2.pdf", width = 7.8, height = 1.7)
